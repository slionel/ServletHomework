...
<div class="container-fluid">
    <div class="row flex-xl-nowrap">
        ...
        <main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
            <h1 class="bd-title">布置作业</h1>
            <br>
            <h4>开放日期</h4>
            <form class="form-group" method="get" action="HomeworkInsertServlet">
                <input type="date" class="form-control" name = "opendate">
                <div class="container mt-3">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <select class="btn btn-outline-secondary" type="button" name="type">
                                <option>竞赛</option>
                                <option>结对</option>
                            </select>

                        </div>
                        <input type="text" class="form-control" placeholder="作业题目" name="title">
                    </div>

                    <div class="input-group mb-3">
                        <textarea type="text" class="form-control" placeholder="作业要求" name="requirement"></textarea>
